import{_ as s,o as n,c as e,R as a}from"./chunks/framework.T1JPdAmG.js";const p="/myBlog/assets/mark-prototype.fsG2itz5.png",o="/myBlog/assets/mark-proto.AGccERTc.png",l="/myBlog/assets/mark-constructor.xROAA9zJ.png",t="/myBlog/assets/mark-proto-prototype.K5_zCShs.png",P=JSON.parse('{"title":"JavaScript","description":"","frontmatter":{},"headers":[],"relativePath":"markdown-Javascript.md","filePath":"markdown-Javascript.md"}'),r={name:"markdown-Javascript.md"},c=a(`<h1 id="javascript" tabindex="-1">JavaScript <a class="header-anchor" href="#javascript" aria-label="Permalink to &quot;JavaScript&quot;">​</a></h1><h2 id="深入原型到原型链" tabindex="-1">深入原型到原型链 <a class="header-anchor" href="#深入原型到原型链" aria-label="Permalink to &quot;深入原型到原型链&quot;">​</a></h2><p>构造函数创建对象，我们先使用构造函数创建一个对象：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">function Person() {</span></span>
